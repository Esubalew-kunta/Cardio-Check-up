...
export default function Equipe() {
  ...
  return (
    <>
      <Seo
        title="Notre équipe"
        description="Rencontrez l'équipe médicale Cardio Check-up : six spécialistes complémentaires (cardiologie, chirurgie cardiaque et vasculaire, médecine vasculaire et nutrition) à Paris 17."
        path="/equipe"
      />
